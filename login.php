...
if(isset($_POST['submit']))
  {
    ...
    $v_data = "SELECT * FROM voters WHERE email = '$email'  and Password = '$password'";
...
?>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column bg-white border rounded">
                <div class="row">
            <div class="col-md-6 ">
            <img src="assets/img/bg.jpg" class='w-100 'style='height:20rem' alt="">
            <a href="admin/login.php" class='float-right '>Login as Admin?</a>
            </div>
            <div class="col-md-6 border">
            <!--Display error message -->
            <h6 class=" text-danger p-3 error  <?php echo $error ?> " style="background-color:rgba(255,0,0,0.1)">*  <?php echo $msg ?> *
</h6>
                <h2 class="form-title text-center text-dark pt-5">Login as Voter</h2>
